...
(function() {
	...
	function attachEventListeners() {
		 ...
		 */
		// Touch 
		toggle.addEventListener("touchstart", handleTouchStart, false);
		toggle.addEventListener("touchmove", handleTouchMove, false); // in class this was added on window
		toggle.addEventListener("touchend", handleTouchEnd, false); // in class this was added on window

		// Mouse
		toggle.addEventListener("mousedown", handleMouseDown, false);
		toggle.addEventListener("mousemove", handleMouseMove, false); // in class this was added on window
		toggle.addEventListener("mouseup", handleMouseUp, false);  // in class this was added on window
	}
	...
	*/
	...
	document.addEventListener("DOMContentLoaded", function(event) {
	  ...
	  evt.preventDefault();
	  sliding = true;
	  toggleTracker.addMovement(evt.changedTouches[0].pageX);
	}
	...
	function handleMouseDown(evt) {
	  evt.preventDefault();
	  sliding = true;
	  toggleTracker.addMovement(evt.pageX);
	}
